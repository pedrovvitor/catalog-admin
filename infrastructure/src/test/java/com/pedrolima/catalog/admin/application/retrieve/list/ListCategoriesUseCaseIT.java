package com.pedrolima.catalog.admin.application.retrieve.list;
...
public class ListCategoriesUseCaseIT {
    ...
    void mockup() {
        final var categories = Stream.of(
                ...
                Category.newCategory("Netflix Originals", "Titles created by Netflix", true),
                Category.newCategory("Amazon Originals", "Titles created by Amazon", true),
    ...
    public void givenAValidTerm_whenTermDoesntMatchPrePersisted_shouldReturnEmptyPage() {
        ...
        final var expectedTerms = "test test";
